...
public class Options extends JFrame {
	...
	public Options() {
		...
		mntmNewMenuItem_13.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String h = "local host";
				String reciever ="kano.charlie@gmail.com";
				String sender = "tsogt.batider0@gmail.com";
				...
				try {
					...
					msg.addRecipients(javax.mail.Message.RecipientType.TO, sender);
					productList.lowInventory();
					Transport.send(msg);
